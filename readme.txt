=== Kings FAQ ===
Contributors: KingsRRF
Donate link: http://wordpresstalks.org
Tags: faq, jquery faq, testimonial
...
1. Install the plugin. (Find the instructions in the "Installation" section.) <br>
2. Find the custom post "<i>FAQ Items</i>" in your WordPress dashboard and click on it's submenu: Add New. You can add category as well. <br>
3. Use the shortcode to show all your tabs anywhere in your WordPress site. <pre>[kings-faq]</pre><br>
4. This shortcode supports 6 attributes: "category", "orderby", "order", "color", "bg" & "count". <br>

<strong> Examples </strong>

<pre>[kings-faq category="mycat" orderby="title" order="ASC" color="black" bg="#ccc" count="5"]</pre>
